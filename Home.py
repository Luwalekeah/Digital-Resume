...
resume_file = current_dir / "static" / "assets" / "Daniel_Cooke_CV.pdf"
profile_pic = current_dir / "static" / "assets" / "profile-pic.png"
...
st.write(
    """
- ✔️ 6 Years experience extracting actionable insights from data
- ✔️ Strong working experience in Python, SQL, and Tableau
- ✔️ Excellent knowledge in building data pipelines and finding anomalies
...
- 📊 Data Visualization: Tableau, Excel, SAP BOBJ
